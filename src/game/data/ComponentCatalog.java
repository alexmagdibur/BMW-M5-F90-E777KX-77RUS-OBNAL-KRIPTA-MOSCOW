...
public class ComponentCatalog {
    ...
    public static List<Component> getEngines() {
        return List.of(
            new Component("V6 Атмосферный",      ComponentType.ENGINE, 300_000,   60),
            new Component("V8 Турбо",             ComponentType.ENGINE, 600_000,   80),
            new Component("V10 Гибрид",           ComponentType.ENGINE, 1_200_000, 95)
        );
    }

    public static List<Component> getTransmissions() {
        return List.of(
            new Component("5-ст. Механика",       ComponentType.TRANSMISSION, 150_000, 55),
            new Component("7-ст. Автомат",        ComponentType.TRANSMISSION, 300_000, 75),
            new Component("8-ст. Секвентальная",  ComponentType.TRANSMISSION, 600_000, 90)
        );
    }

    public static List<Component> getSuspensions() {
        return List.of(
            new Component("Стандартная подвеска", ComponentType.SUSPENSION, 100_000, 50),
            new Component("Спортивная подвеска",  ComponentType.SUSPENSION, 250_000, 70),
            new Component("Адаптивная подвеска",  ComponentType.SUSPENSION, 500_000, 88)
        );
    }

    public static List<Component> getChassis() {
        return List.of(
            new Component("Стальное шасси",       ComponentType.CHASSIS, 200_000, 55),
            new Component("Алюминиевое шасси",    ComponentType.CHASSIS, 450_000, 72),
            new Component("Карбоновое шасси",     ComponentType.CHASSIS, 900_000, 92)
        );
    }
